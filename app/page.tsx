...
export default async function Home() {
  ...
  return <>
    ...
    <main>
      <section className="hero"><div className="container"><div className="eyebrow">SARAWAK</div><h1><T k="headline"/></h1><p className="lead"><T k="lead"/></p><p><Link className="btn primary" href="/opportunities"><T k="enterMarket"/></Link></p><div className="kpis"><div className="kpi"><strong>{opportunities.length}</strong><span><T k="sarawakIndexed"/></span></div><div className="kpi"><strong>{metrics.verified_deals}</strong><span><T k="verifiedDeals"/></span></div><div className="kpi"><strong>RM{Number(metrics.verified_business_generated).toLocaleString()}</strong><span><T k="verifiedBusiness"/></span></div><div className="kpi"><strong>1</strong><span><T k="focusedMarket"/></span></div></div></div></section>
