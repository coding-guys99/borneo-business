...
const copy={
 en:{open:'Open information',eyebrow:'INFORMATION',title:'Project information',lead:'Quick reference for names, abbreviations and the original public document.',close:'Close',doc:'OFFICIAL DOCUMENT',original:'Original public source',docText:'Open or download the official source copy without searching through the agency website again.'},
 zh:{open:'打开说明',eyebrow:'说明',title:'术语与官方资料',lead:'快速查看本页出现的机构名称、缩写与官方来源。',close:'关闭',doc:'官方文件',original:'官方公开来源',docText:'直接打开或下载官方来源资料，不需要再到政府网站重新寻找。'},
 ms:{open:'Buka maklumat',eyebrow:'MAKLUMAT',title:'Maklumat projek',lead:'Rujukan ringkas untuk nama, singkatan dan dokumen awam asal.',close:'Tutup',doc:'DOKUMEN RASMI',original:'Sumber awam asal',docText:'Buka atau muat turun salinan sumber rasmi tanpa mencarinya semula di laman agensi.'}
} as const
